    ...
    <div className={styles.overview}>
      ...
      <div className={styles.topHeader}>
        <div className={styles.headerContent}>
          <h1 className={styles.welcomeTitle}>Welcome back, Dr. Musa</h1>
          <p className={styles.dateText}>15 October, 2025</p>
        </div>
      ...
      <div className={styles.doctorProfileSection}>
        ...
        <div className={styles.statisticsGrid}>
          <div className={styles.statCard}>
            <h3 className={styles.statTitle}>Today's Appointment</h3>
            <div className={styles.statValue}>
              <p className={styles.statNumber}>6</p>
              <p className={styles.statUnit}>Scheduled</p>
            </div>
          </div>

          <div className={styles.statCard}>
            <h3 className={styles.statTitle}>Completed Consultation</h3>
            <div className={styles.statValue}>
              <p className={styles.statNumber}>12</p>
              <p className={styles.statUnit}>Completed</p>
            </div>
          </div>
          ...
          <div className={styles.statCard}>
            ...
            <div className={styles.statValue}>
              ...
              <p className={styles.statUnit}>Registered</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.upcomingConsultation}>
        <div className={styles.consultationHeader}>
          <h3 className={styles.consultationTitle}>Upcoming Consultation</h3>
      ...
      <div className={styles.recentPatientsSection}>
        <div className={styles.recentPatientsHeader}>
          <h3 className={styles.recentPatientsTitle}>Recent Patient</h3>
        </div>
        ...
        <div className={styles.patientsRows}>
          <div className={styles.consultationRows}>
            ...
            <div className={styles.patientRow}>
              ...
              <button className={styles.viewRecordButton}>View Record</button>
            </div>
